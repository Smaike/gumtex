...
$serv = $model->lastEvent->getServices()->one();
?>
...
Дата оказания последней услуги: <?=$model->lastEvent->date?><br>
Вид услуги: <?=$serv->name?><br>
Консультант: <?=$model->consultant->fullName?><br><br>
